...
# Normal transport problem:
#   π₀ = N(0, I)
#   π₁ = N(μ₁, σ₁²·I)
# Annealing between these two MvNormals via the perturbed linear path.
const MU0   = -1.0
const SIGMA0 = 0.1 
const MU1   = 1.0
const SIGMA1 = 0.1
...
function make_sampling_problem()
    D0 = MvNormal(fill(MU0, DIMENSION), SIGMA0^2 * I)
    D1 = MvNormal(fill(MU1, DIMENSION), SIGMA1^2 * I)
...
directory(config) = "normal-transport"

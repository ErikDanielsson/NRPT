...
# --- Synthetic data ---
# True parameters: means at -3, 0, 3; σ=0.8; weights 0.3, 0.4, 0.3
# const y_obs = let
#     rng = MersenneTwister(42)
#     true_means   = [-3.0, 0.0, 3.0]
#     true_stds    = [0.8, 0.8, 0.8]
#     true_weights = [0.3, 0.4, 0.3]
#     n = 300
#     zs = rand(rng, Categorical(true_weights), n)
#     [rand(rng, Normal(true_means[z], true_stds[z])) for z in zs]
# end


# --- Prior hyperparameters ---
const MU_PRIOR_MEAN = mean(sdata)
